...
import AccountBalanceCtrl from "controllers/account-balance-ctrl";
...
class App {
  ...
  private initControllers(): void {
    const balanceCtrl = new AccountBalanceCtrl();

    this.app.use("/account/balance", balanceCtrl.initRoute());
  }
